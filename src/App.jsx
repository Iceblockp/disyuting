...
const App = () => {
  return (
        ...
        <div className=" min-h-screen bg-cover bg-center overflow-hidden bg-[url('https://templates.casloop.net/disyuting/wp-content/uploads/sites/19/2023/11/Plain-GradientDisyuting.jpg?fbclid=IwAR0lUiyw4t5Tkdh6zRRhTMWtsAqrUG5A6D6HeH_lyu9NPiW5DKAh6QdMYeg')]">
        <NavBar/>
    <Routes>
