...
const Awards = () => {
  ...
  return (
    ...
    //   <div className="mx-auto p-1 max-lg:w-[89%] 2xl:max-w-[1620px] "> </div>

    //   </div>

    <div className="pb-[200px] w-full flex ">
      <div className="flex mx-0 lg:mx-[5px] w-full">
        <div
          className="w-full 
        lg:w-[89%] 2xl:max-w-[1620px] mx-auto "
        >
          <div className="w-full px-[30px] lg:px-0 py-[10px] lg:py-[5px]">
            <div className=" select-none flex flex-col min-[1425px]:flex-row gap-[30px]  ">
              {/* img */}
              ...
              <div className=" w-[60%] max-[1425px]:w-[100%] flex flex-col gap-[30px] max-[1425px]:gap-[12px] p-1">
                {/* awards title */}
                <p
                  className=" text-xl max-md:text-lg max-md:text-center leading-16 font-bold font-para "
                  style={{ color: "#D5E8EB" }}
                >
                  Disyuting Awards
                </p>
                <div className="h-auto max-md:justify-center text-6xl font-bold tracking-wide font-heading text-white flex uppercase w-[96%] max-[1395px]:text-3xl max-md:text-2xl">
                  <h1>
