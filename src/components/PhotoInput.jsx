    ...
    <div className="flex w-full">
      <div className="flex mx-0 sm:p-10 md:px-5 lg:mx-[5px] w-full">
        <div className="w-full mx-auto">
              ...
              <div className=" lg:max-w-[416px]  mx-auto flex justify-center items-center text-center">
                <div className="lg:text-start text-center">
                  <h3 className="md:p-5 lg:p-0 uppercase text-[33px] font-bold font-heading text-white">
                    we created high quality visuals with the services provided
                  </h3>
                  <p className=" font-para text-white text-[14px] ">
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                    Odio quisquam ex sapiente consequuntur?
                  </p>
                </div>
              </div>
            </div>
            <div data-aos="fade-left"  data-aos-duration="2500" className="md:w-full col-span-1 md:col-span-2 lg:col-span-6">
          ...
          <div data-aos-duration="2500" data-aos-once="true" data-aos="fade-up">
